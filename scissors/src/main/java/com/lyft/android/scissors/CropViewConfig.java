...
public class CropViewConfig {
    ...
    public static final float DEFAULT_MAXIMUM_SCALE = 15f;
    public static final float DEFAULT_MINIMUM_SCALE = 0.5f;
    public static final int DEFAULT_IMAGE_QUALITY = 100;
    public static final int DEFAULT_VIEWPORT_OVERLAY_PADDING = 0;
    public static final int DEFAULT_VIEWPORT_OVERLAY_COLOR = 0x80000000; // Black with 200 alpha
    ...
    void setViewportRatio(float viewportHeightRatio) {
        this.viewportRatio =
                viewportHeightRatio <= 0 ? DEFAULT_VIEWPORT_RATIO : viewportHeightRatio;
    }
