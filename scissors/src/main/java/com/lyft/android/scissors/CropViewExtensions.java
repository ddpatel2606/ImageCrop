...
class CropViewExtensions {
    ...
    static Rect computeTargetSize(int sourceWidth, int sourceHeight, int viewportWidth, int viewportHeight) {
        ...
        final int recommendedWidth = (int) ((sourceWidth * scale) + CropViewConfig.DEFAULT_MINIMUM_SCALE);
        final int recommendedHeight = (int) ((sourceHeight * scale) + CropViewConfig.DEFAULT_MINIMUM_SCALE);
